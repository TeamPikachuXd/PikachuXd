...
# Copyright (C) 2021 TeamPikachuXd
...
from PikachuXd import dp
from PikachuXd.decorator import register
from PikachuXd.modules.utils.connections import chat_connection
from PikachuXd.modules.utils.language import get_strings, get_strings_dec
from PikachuXd.modules.utils.message import (
    InvalidTimeUnit,
    convert_time,
    get_args,
    need_args_dec,
)
from PikachuXd.modules.utils.restrictions import ban_user, kick_user, mute_user
from PikachuXd.modules.utils.user_details import get_user_link, is_user_admin
from PikachuXd.services.mongo import db
from PikachuXd.services.redis import bredis, redis
from PikachuXd.utils.cached import cached
from PikachuXd.utils.logger import log
...
PikachuXd: <code>Please send expiration time [...]</code>
