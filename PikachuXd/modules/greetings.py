...
from PikachuXd import BOT_ID, BOT_USERNAME, bot, dp
from PikachuXd.config import get_str_key
from PikachuXd.decorator import register
from PikachuXd.services.apscheduller import scheduler
...
from PikachuXd.stuff.fonts import ALL_FONTS
