...
Also notes perfectly working in PM with PikachuXd.
...
PikachuXd can save notes from other bots, just reply /save on the saved message from another bot, saving pictures and buttons supported aswell.
