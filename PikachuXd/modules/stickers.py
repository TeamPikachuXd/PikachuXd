...
from PikachuXd.services.events import register as PikachuXd
...
@PikachuXd(pattern="^/searchsticker (.*)")
async def _(event):
...
async def _(event):
    ...
    packshortname = f"PikachuXd_stickers_{userid}"
    kanga = await event.reply("Hello, This Sticker Looks Noice. Mind if PikachuXd steal it")
    ...
    if is_a_s:
        ...
        packshortname = f"PikachuXd_animated_{userid}"
