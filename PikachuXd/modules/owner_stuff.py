...
from PikachuXd import PikachuXd_VERSION, OWNER_ID, bot, dp
from PikachuXd.decorator import COMMANDS_ALIASES, REGISTRED_COMMANDS, register
from PikachuXd.modules import LOADED_MODULES
from PikachuXd.services.mongo import db, mongodb
...
async def restart_bot(message):
    await message.reply("PikachuXd will be restarted...")
    args = [sys.executable, "-m", "PikachuXd"]
...
async def stats(message):
    if message.from_user.id == OWNER_ID:
        text = f"<b>PikachuXd {PikachuXd_VERSION} stats</b>\n"
