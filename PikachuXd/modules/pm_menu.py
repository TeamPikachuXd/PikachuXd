...
from PikachuXd.modules.utils.disable import disableable_dec
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/TeamPikachuXd/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/PikachuXdUpdates"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/PikachuXdSupport"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add PikachuXd to your group",
            url=f"https://telegram.me/PikachuXdbot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/PikachuXdBOT?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
