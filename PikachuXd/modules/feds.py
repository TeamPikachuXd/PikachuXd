...
from PikachuXd import BOT_ID, OPERATORS, OWNER_ID, bot, decorator
...
In both cases PikachuXd will help you.
...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means PikachuXd will wait file message from you. Type /cancel to leave from it.
