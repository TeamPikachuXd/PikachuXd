...
from PikachuXd.config import get_bool_key, get_int_key, get_list_key, get_str_key
from PikachuXd.services.telethon import tbot
from PikachuXd.utils.logger import log
from PikachuXd.versions import PikachuXd_VERSION

log.info("----------------------")
log.info("|      PikachuXd      |")
log.info("----------------------")
log.info("Version: " + PikachuXd_VERSION)

if get_bool_key("DEBUG_MODE") is True:
    PikachuXd_VERSION += "-debug"
