...
from PikachuXd import BOT_USERNAME, dp
from PikachuXd.config import get_bool_key
from PikachuXd.modules.error import parse_update
from PikachuXd.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("PikachuXd.utils.filters." + module_name)
